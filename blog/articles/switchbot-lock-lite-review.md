...
> 玄関で鍵を出して、回して、抜いて、しまう。たったこれだけの動作で**年間5時間**が消えている。
> しかも「鍵をかけ忘れた気がする」と引き返した回数を、あなたは覚えているだろうか。
...
## SwitchBot ロックLite とは｜「賃貸の最終回答」と言える後付けスマートロック
...
ここが SwitchBot ロックLite を **賃貸暮らしの人間が真っ先に検討すべき** 最大の理由だ。「工事不要」という言葉は誇張ではなく、構造上そうなっている。

...
でも、本当にうれしいのは「年4.9時間の節約」そのものじゃない。**"鍵を探す" ために脳のリソースを使わなくて済む**ことだ。「あれ、どこに入れたっけ?」とカバンを漁る数秒、雨の中で傘を持ちながら鍵をひねるストレス、両手が買い物袋で塞がって地面に置く不快感——これらが全部、**指で触れる0.3秒で消える**。時間そのものより「イライラの総量」が減ることのほうが、毎日の満足度にはずっと大きい。

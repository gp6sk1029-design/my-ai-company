...
| オートロック | あり（**タイマー式**・解錠から**1秒〜60分**後に自動施錠） |
...
![賃貸ドアの取付前 ── サムターンと既存の補助ロック](https://www.ootanisatan.com/wp-content/uploads/2026/05/switchbot-door-before.jpg)賃貸ドアの取付前 ── サムターンと既存の補助ロック
...
![取り付け高さを調整しているところ ── 手順1「採寸・高さ合わせ」](https://www.ootanisatan.com/wp-content/uploads/2026/05/switchbot-screwdriver-fix.jpg)取り付け高さを調整しているところ ── 手順1「採寸・高さ合わせ」

> 💬 えっ、両面テープって…落ちません? 重力で。地震とかでドカンと落ちて、家に入れなくなったら困るんですけど

> 💬 僕も最初それを疑った。でも採用されてるのは3M製の超強力VHBテープで、しっかり圧着すれば200g台の本体くらい余裕で支えられる強度になる。実際、**"重さで落ちた" 事例は公式コミュニティ・SNSを総当たりしても見つからなかった**よ

![本体裏面の 3M VHB™ テープ（赤） ── 産業用の超強力両面テープ](https://www.ootanisatan.com/wp-content/uploads/2026/05/switchbot-3m-vhb-tape.jpg)本体裏面の 3M VHB™ テープ（赤） ── 産業用の超強力両面テープ
...
![取付完了状態 ── 賃貸ドアに違和感なく溶け込む本体](https://www.ootanisatan.com/wp-content/uploads/2026/05/switchbot-install-done.jpg)取付完了状態 ── 賃貸ドアに違和感なく溶け込む本体
...
![指紋認証パッドを玄関外側に設置 ── 既存の鍵穴はそのまま使える](https://www.ootanisatan.com/wp-content/uploads/2026/05/switchbot-fingerpad-installed.jpg)指紋認証パッドを玄関外側に設置 ── 既存の鍵穴はそのまま使える
...
![テンキー＋指紋センサー一体型の認証パッド](https://www.ootanisatan.com/wp-content/uploads/2026/05/switchbot-fingerpad-keypad.jpg)テンキー＋指紋センサー一体型の認証パッド
...
でも、本当にうれしいのは「年4.9時間の節約」そのものじゃない。「あれ、どこに入れたっけ?」とカバンを漁る数秒、雨の中で傘を持ちながら鍵をひねるストレス、両手が買い物袋で塞がって地面に置く不快感——こうした**小さなイライラが全部、指で触れる0.3秒で消える**ことのほうが、毎日の満足度にはずっと大きい。
...
ロックLite はドアの開閉センサーは持たず、**解錠してから設定した時間が経つと自動で施錠するタイマー式**だ。時間は1秒〜60分で設定可。私は10秒に設定している。

### 「鍵かけ忘れ」が物理的にゼロになる心理メカニズム

家を出て駅まで歩く途中、ふと頭をよぎる「**あ、鍵かけたっけ?**」——これが**消える**。解錠してから設定した時間が過ぎれば**必ず自動でかかっている**から、確認する必要すらない。
...
> 💬 浮くんじゃない。**今まで損していたものが、見えるようになっただけ**だ。ガジェットは "便利グッズ" じゃなくて、**今まで気づかなかった損失を計測可能にする計器** なんだよ
...
- 🛒 [Amazonで見る：Panasonic CR123A リチウム電池（交換用・4個パック）](https://www.amazon.co.jp/dp/B08RC7DF53/?tag=gp6sk1029-22)

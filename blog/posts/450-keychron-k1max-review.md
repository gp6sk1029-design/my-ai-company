...
## 📐 ガジェット投資対効果（ROI） ── 「2.5万円のキーボード」は元が取れるか？

このブログの信条は**「投資対効果は数字で示す」**。Keychron K1 Maxは約25,000円。本当に元が取れる買い物なのか計算します。
...
| 項目 | 計算 | 結果 |
|---|---|---|
| **損益分岐日数** | 25,000円 ÷ 300円/日 | **約83日（約3ヶ月）** |
| 3年間使用時の累計節約価値 | 300円 × 1,095日 | **約32.8万円** |
| 3年間の純利益 | 32.8万円 − 2.5万円 | **約30.3万円** |
| 1日あたりの実質コスト（3年使用） | 25,000円 ÷ 1,095日 | **わずか23円/日** |

**3ヶ月で元が取れて、残り2年9ヶ月は純利益**。さらに腱鞘炎リスク回避による医療費削減・キャリア継続価値を含めれば、ROIはさらに跳ね上がります。

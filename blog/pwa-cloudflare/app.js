...
【最重要・写真の扱い】
- 添付画像がある場合：その実機写真を主役として**そのまま使う**（形状・色・ロゴ・質感・背景を一切変えない）。その上に注釈（ラベル・矢印・図形）だけを重ねる。写真そのものは加工・再生成しない。
- 添付画像がない場合のみ、商品を写実的に描いてから注釈を重ねる。
...
【配色】
${mood || '写真はそのまま / 見出し青 #1d4ed8 / 矢印・強調図形オレンジ #f97316 / ラベルは白背景＋黒文字 #111827'}

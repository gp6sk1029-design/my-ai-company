...
var GEMINI_ENDPOINT = /* @__PURE__ */ __name((key) => `https://generativelanguage.googleapis.com/v1beta/models/${GEMINI_MODEL}:generateContent?key=${key}`, "GEMINI_ENDPOINT");
var OUTPUT_SCHEMA = {
  type: "object",
  properties: {
    ingredients: {
...
var GEMINI_ENDPOINT2 = /* @__PURE__ */ __name((key) => `https://generativelanguage.googleapis.com/v1beta/models/${GEMINI_MODEL2}:generateContent?key=${key}`, "GEMINI_ENDPOINT");
var MEAL_SCHEMA = {
  type: "object",
  properties: {
    name: { type: "string" },
...
// ../.wrangler/tmp/pages-YlsRuc/functionsRoutes-0.9004559094645637.mjs
var routes = [
  {
...
// ../../../../../.local/npm-global/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../.local/npm-global/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-Y2nzog/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Y2nzog/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.10165519314322835.mjs.map
